...
export function add(style, prop, value) {
  ...
  if (!style.__style)
    Object.defineProperty(style, '__style', { configurable: true, value: Object.create(null, {}) })

  add(style.__style, prop, value)
}
...
export function assign(obj, obj2) {
  if (obj2.__style) {
    obj.__style
      ? assign(obj.__style, obj2.__style)
      : Object.defineProperty(obj, '__style', { value: obj2.__style })
  }
...
export function objectToRules(style, suffix = '') {
  ...
  if (style.__style)
    Object.defineProperty(base, '__style', { configurable: true, value: style.__style })
...
export function stylesToCss(style) {
  ...
  , '') + (style.__style ? stylesToCss(style.__style) : '')
}
